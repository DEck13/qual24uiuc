...
You are required to submit your answers to both questions as a pdf file. Your submission should be a reproducible technical report and should include all relevant code necessary to answer the two qualifying exam questions. You can use the Rmd file that generated this pdf file as a template. 

You need to submit your finalized pdf file to Asraa Ibrahim at asraai3@illinois.edu. You can email Asraa Ibrahim at asraai3@illinois.edu if you have any technical difficulties.
