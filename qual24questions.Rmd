...
You are required to submit your answers to the questions in this document as a pdf file. Your submission should be a reproducible technical report and should include all relevant code necessary to answer the two qualifying exam questions. You can use the Rmd file that generated this pdf file as a template. You can submit your finalized pdf file to Aaron Thompson at aaron5@illinois.edu. 

You can email Aaron Thompson at aaron5@illinois.edu if you have any technical difficulties.
